...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <section class="ramadan-sale">
        <div class="ramadan-sale-page-container">
          ...
          <div class="product-carousel-wrapper">
            ...
            <button class="carousel-arrow next-arrow" aria-label="Next Product">
              >
            </button>
          </div>
        </div>
        ...
        <div class="testimonials-wrapper">
          ...
          <div class="testimonial-card">
            <div class="testimonial-top">
              <!-- IMPORTANT: Replace 'images/emily_russell.png' with the correct path to your image -->
              <img
          ...
          <div class="testimonial-card">
            <div class="testimonial-top">
              <!-- IMPORTANT: Replace 'images/mark_taylor.png' with the correct path to your image -->
              <img
      ...
      <!-- Membership Promo Section Start -->
      <section class="membership-promo-section">
        <div class="promo-content">
          ...
          <a href="#" class="promo-signup-btn">Sign Up</a>
        </div>
